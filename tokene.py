...
class Token:
    ...
    class TokenSymbol(Enum):
        NULL, Not, NotEqu, Mod, ModAssign, ID, Keyword, Number, And, LParen, RParen, Mul, MulAssign, Plus, Increase, AddAssign, Comma, Minus, Decrease, SubAssign, Div, DivAssign, Semicolon, Less, Lesser, Assign, Equal, Great, Greater, LBracket, RBracket, EOF, Const, Else, If, Int, Return, Void, While, LBrace, Or, RBrace = range(42)
